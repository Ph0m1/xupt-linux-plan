...
#define SMTPSERVER "smtp://smtp.qq.com:465"
#define USERNAME "ph0m_hu.xa@foxmail.com"
#define PASSWORD "wxldozbzcjbvddji"

class SMTPMailer {
public:
    // 构造函数，初始化SMTP服务器信息和用户认证信息
    SMTPMailer(const std::string& smtpServer = SMTPSERVER, const std::string& username = USERNAME, const std::string& password = PASSWORD);
